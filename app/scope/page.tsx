...
const IN = [
  ...
  ["Ввод параметров отвода", "Тип установки, ток отвода, число отводов, аппарат защиты, рукоятка, IP корпуса"],
  ...
  ["Подбор модели КОМ", "Наименование, номинал, габарит, масса, загрузка по току"],
  ["Формирование кода заказа", "Готовый артикул с расшифровкой каждой из девяти позиций"],
...
const ACCEPT = [
  ...
  "Ток отвода выше предела серии → пояснение с числами и предложение исправления",
  "Суммарный ток отводов выше допустимого → фактическое и предельное значение",
