...
const KINDS = [
  ...
  { label: "Секция Z-образная вертикальная", code: "ZP", re: /(?:вертикал.*z[- ]?образ|z[- ]?образ.*вертикал)|vertical z[- ]?(?:section|offset)/i },
  { label: "Секция Z-образная горизонтальная", code: "ZD", re: /(?:горизонт.*z[- ]?образ|z[- ]?образ.*горизонт)|horizontal z[- ]?(?:section|offset)/i },
  ...
  { label: "Стыковочный элемент", code: "G", re: /стык|соедин(?:ит|ен)|joint/i },
